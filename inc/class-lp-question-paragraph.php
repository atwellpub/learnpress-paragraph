...
if ( ! class_exists( 'LP_Question_Paragraph' ) ) {

	/**
	 * Class LP_Question_Paragraph
	 */
	class LP_Question_Paragraph extends LP_Question {

		/**
		 * @var string
		 */
		protected $_question_type = 'paragraph';

		/**
		 * @var string
		 */
		static $_shortcode_pattern = '!\[paragraph(.*)fill=["|\'](.*)["|\']!iSU';
		...
		/**
		 * LP_Question_Paragraph constructor.
		 *
		...
		public function render( $args = false ) {
			learn_press_paragraph_get_template( 'answer.php', array( 'question' => $this ) );
		}
